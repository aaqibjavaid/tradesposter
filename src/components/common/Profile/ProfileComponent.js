                  ...
                  <div className="div2">
                    <div className="w-[150px] h-[150px] relative">
                      <img
                        ...
                        //   }}
                      />
                      <span className="top-1 right-4 absolute w-[20px] h-[20px] bg-white rounded-full  dark:border-gray-800  flex items-center justify-center pt-[6px] pr-1">
                        <i className="fi fi-ss-badge-check  text-[20px] text-primaryblue "></i>
                      </span>
                    </div>
                  </div>
                </div>
